                                                    ...
                                                    <a href="#" class="feedRanking-item hov">
                                                        ...
                                                        <div class="feedRanking-subInfo">
                                                            ...
                                                            foreach ($categorys as $category) { ?>
                                                                <span class="feedRanking-category js-scroll"><?php echo $category->name; ?></span>
                                                            <?php } ?>
                                                            <span class="feedRanking-date js-scroll"><?php the_time("Y" . ".m" . ".d"); ?></span>
                                                        </div>
                                                        <h2 class="feedRanking-ttl js-matchHeight js-scroll"><?php the_title(); ?></h2>
                                                        <p class="feedRanking-text js-scroll"><?php $inText = get_the_excerpt();
